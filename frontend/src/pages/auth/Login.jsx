...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // ✅ FIX: Robust URL construction to prevent relative paths or double "/api"
      ...
      if (contentType?.includes("application/json")) {
        ...
        // Server returned an error but not JSON (e.g., Vite 404 page)
      ...
      const targetPath =
        ...
        (role === "donor"
          ...
          : role === "hospital"
            ? "/hospital"
            : role === "blood_lab" // Note: matches your schema "blood_lab" or "blood-lab"
              ? "/lab"
              : role === "admin"
                ? "/admin"
                : "/");
